...
### Approximation I
In the first approximation step, I derive a target policy update rule as an intermediate result and show that this intermediate update not only ensures monotonic policy improvements but also enjoys a convergence rate of O(1/K) for near-optimal policies.
<img src='/images/AWR/approx_1.png'>
<img src='/images/AWR/target_policy.png'>
<img src='/images/AWR/thm_1.png'>
This sub-optimality upper bound has no dependence on the size of the state space and the distribution mismatch coefficient, even though the target policy is updated under a different measure µ.
